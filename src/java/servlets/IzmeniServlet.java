...
public class IzmeniServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
       String server =request.getParameter("id");
        int id = Integer.parseInt(request.getParameter("idLica"));
        
        Fizickiserver f1=new Fizickiserver(server);
//        for(Fizickolice lice : Data.lica){
//            if(lice.getId()==id){
//                request.setAttribute("lice", lice);
//                if(lice.getServeri().contains(f1)){
//                    if(f1.datum==null){
//                           request.setAttribute(server, f1);
//                           
//                    
//                    }
//                
...
//        }
       ...
       int cena=7;
        ...
        int i = f.getServeri().lastIndexOf(f1);
            f.getServeri().set(i, s);
